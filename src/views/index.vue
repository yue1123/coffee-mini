<script setup lang="ts">
	...
	import UserList from '@/components/UserListDrawer/index.vue'
...
<template>
	<GradientBlurBg :colors="colors">
		<div
			class="pt-safe pb-safe select-none w-full h-full flex flex-col overflow-hidden text-white"
		>
			...
			<div class="embla flex-1 w-full pb-6 px-4" ref="emblaRef">
				<div class="embla__container flex space-x-4 shrink-0 h-full w-full">
					...
					>
						<Card :background="bg" class="shadow-2xl h-full w-[85vw]">
							...
							<div
								class="w-full py-14 absolute bottom-0 text-white text-center space-y-2"
							>
